...
export const SEARCH_CRITERIA = {
  flights: "Finding, comparing or planning airline flights, tickets, fares, a departure and destination, cabin or passenger options. Includes 'flights from Singapore to Tokyo', 'one way London to New York', 'cheap flights to Bali'. Excludes explanations of how airplanes fly, bird flight, negated bookings, and hotel-only stays.",
  hotels: "Finding or booking hotels, accommodation, a place to stay overnight, resorts or guest rooms, with dates, amenities, guests or a budget. Includes 'hotels in Tokyo with a pool', 'where to stay in Singapore for two nights'. Prefer hotels over places when overnight accommodation is the main need; excludes explanations of hotel management or a film named Hotel.",
  video: "Find or watch online videos, tutorials in video form, clips, trailers, YouTube videos, or short/long video content. Includes 'videos of the northern lights', 'sourdough video tutorial', 'watch the Dune trailer'. A movie's facts, title alone or cinema screening belongs to movies; general explanation of a topic does not request a video.",
  shopping: "Shopping for, buying or comparing products to purchase, including a price budget, deals, item features, or a product category with buying intent. Includes 'noise cancelling headphones under $200', 'buy running shoes', 'best laptop to buy'. Prefer shopping over compare for purchase-oriented product comparisons. A product history, repair question, or company stock price is not shopping.",
  images: "Find, browse or search for existing images, pictures, photographs, visual references or wallpapers. Includes 'images of Earth from space', 'pictures of the Moon', 'architecture photo inspiration'. Not image generation or editing (general), and not a color picker, video request, or explanation of a camera.",
  ...
  finance: "A current financial market quote, compound interest or investment-growth calculation, stock/share price, ticker performance, or market chart, including bare recognizable ticker-plus-price queries. Examples: 'AAPL share price', 'bitcoin price today'. Excludes company product searches, general financial explanations, annual report document searches, and conversions between monetary amounts (convert).",
  places: "Finding or visiting physical places: nearby cafes, restaurants, shops, attractions, opening hours, directions, or local services. Includes 'cafes nearby', 'quiet places to work near me', 'museum opening hours'. Hotel/accommodation booking needs belong to hotels; flights belong to flights. Prefer movies for cinema showtimes and weather for forecasts. Excludes website-only restrictions and general explanations of a location's history.",
  movies: "Film discovery, movie titles such as Interstellar and Dune Part Two, film facts, cinema showtimes, screening schedules, or where a movie is playing. Includes 'Dune showtimes' and 'family films in cinemas this weekend'. Explicit video/trailer viewing or video search belongs to video. A screening time is movies, not generic date filtering. Excludes film-essay requests and unrelated uses of words such as dune.",
